...
namespace MultitrackPlayer.Utils.DragDrop
{
    public interface IDropInfo
    {
        ...
        /// </summary>
        MultitrackPlayer.Utils.DragDrop.IDragInfo DragInfo { get; }
    ...
    public class DropInfo : IDropInfo
    {
        ...
        /// </param>
        public DropInfo(object sender, DragEventArgs e, MultitrackPlayer.Utils.DragDrop.DragInfo dragInfo)
        {
            string dataFormat = MultitrackPlayer.Utils.DragDrop.DragDrop.DataFormat.Name;
        ...
        /// if the drag came from within the framework.
        /// </summary>
        public MultitrackPlayer.Utils.DragDrop.IDragInfo DragInfo { get; private set; }
